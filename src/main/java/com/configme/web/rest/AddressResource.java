...
/**
 * REST controller for managing {@link com.configme.domain.Address}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Address> result = addressRepository
            ...
            .map(
                existingAddress -> {
                    ...
                    if (address.getComplementary() != null) {
                        existingAddress.setComplementary(address.getComplementary());
                    }
