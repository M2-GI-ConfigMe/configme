...
import { Ram } from '@/shared/model/ram.model';
...
describe('Service Tests', () => {
  describe('Ram Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Ram', async () => {
      ...
      it('should not update a Ram', async () => {
      ...
      it('should not partial update a Ram', async () => {
      ...
      it('should return a list of Ram', async () => {
        const returnedFromService = Object.assign(
          {
            speed: 1,
            type: 'BBBBBB',
      ...
      it('should not return a list of Ram', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Ram', async () => {
