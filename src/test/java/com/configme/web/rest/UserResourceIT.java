...
import com.configme.service.mapper.UserMapper;
...
class UserResourceIT {
    ...
    void updateUser() throws Exception {
        ...
        managedUserVM.setBirthdate(UPDATED_BIRTHDATE);
        managedUserVM.setAddress(UPDATED_ADDRESS);
    ...
    void updateUserExistingEmail() throws Exception {
        ...
        anotherUser.setBirthdate(LocalDate.of(2002, 02, 02));
        anotherUser.setAddress(Address.of("java", "hipster", "5", "Rue de l'oublie", "Ville", "zip"));
        ...
        managedUserVM.setBirthdate(updatedUser.getBirthdate());
    ...
    void testUserDTOtoUser() {
        ...
        assertThat(user.getBirthdate()).isEqualTo(DEFAULT_BIRTHDATE);
        assertThat(user.getAddress()).isEqualTo(DEFAULT_ADDRESS);
    ...
    void testUserToUserDTO() {
        ...
        assertThat(userDTO.getBirthdate()).isEqualTo(DEFAULT_BIRTHDATE);
        assertThat(userDTO.getAddress()).isEqualTo(DEFAULT_ADDRESS);
